...
def animate(i):
    ...
    if first_run:
       ...
       rx_bytes_delta=(rx_bytes - rx_bytes_last)/1000000.0
       tx_bytes_delta=(tx_bytes - tx_bytes_last)/1000000.0
       rx_bits_delta=rx_bytes_delta*8.0
       tx_bits_delta=tx_bytes_delta*8.0
       if rx_bits_delta < 0:
          rx_bits_delta =0
       if tx_bits_delta < 0:
          tx_bits_delta =0
